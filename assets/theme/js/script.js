(function (a) {
  ...
  function q(b) {
    ...
    b.find(".carousel-item .col-md-12").each(function () {
      2 > d
        ...
        : "5" == d
        ? a(this).attr("class", "col-md-12 col-lg-15")
        : a(this).attr("class", "col-md-12 col-lg-" + 12 / d);
    });
  ...
  a.fn.footerReveal = function () {
    function b() {
      !h && c.outerHeight() <= e.outerHeight()
        ? (c.css({ "z-index": -999, position: "fixed", bottom: 0 }),
          c.css({ width: d.outerWidth() }),
          d.css({ "margin-bottom": c.outerHeight() }))
        : (c.css({ "z-index": "", position: "", bottom: "" }),
          c.css({ width: "" }),
          d.css({ "margin-bottom": "" }));
    }
    var c = a(this),
              ...
              if (c.hash) {
                ...
                a(d ? "body" : c.hash).each(function () {
                  ...
                  a(this).hasClass("panel-collapse") ||
                    ...
                    a("html, body")
                      .stop()
                      .animate({ scrollTop: d }, 800, "easeInOutCubic");
                });
                break;
              }
        ...
        var d = a(
            ...
            .not(function () {
              return a(this)
                .parents()
                .is(
                  "a, p, .navbar, .mbr-arrow, footer, .iconbox, .mbr-slider, .mbr-gallery, .mbr-testimonial .card-block, #cookiesdirective, .mbr-wowslider, .accordion, .tab-content, .engine, #scrollToTop, .modal-content"
                );
            })
            .not(function () {
  ...
  if (!f && !a.isMobile()) {
    ...
    !m.find(".navbar").hasClass("collapsed") &&
      991 < u &&
      (m.find("ul.navbar-nav li.dropdown").hover(
        function () {
      ...
      m.find("ul.navbar-nav li.dropdown .dropdown-menu .dropdown").hover(
        function () {
          a(this).hasClass("open") || a(this).find("a")[0].click();
        },
        function () {
  ...
  f ||
    ("undefined" === typeof window.initClientPlugin &&
      0 != a(document.body).find(".clients").length &&
    ...
    "undefined" === typeof window.initPopupBtnPlugin &&
      0 != a(document.body).find("section.popup-btn-cards").length &&
    ...
    "undefined" === typeof window.initSwitchArrowPlugin &&
      ...
      a(document).ready(function () {
        0 != a(".accordionStyles").length &&
          a('.accordionStyles .card-header a[role="button"]').each(function () {
    ...
    "undefined" === typeof window.initTabsPlugin &&
      ((window.initTabsPlugin = !0), r(document.body)),
    ...
    a(document).on("add.cards", function (b) {
      a(b.target).find(".form-with-styler").length &&
        ...
        a(b)
          ...
          .each(function () {
            a(this).datetimepicker &&
              a(this).datetimepicker({ format: "H:i", datepicker: !1 });
          }));
    });
  else
